# Session 4 Extraction — Final Document
## Marvel-616 Roleplay — Canon Reconstruction Phase 1
...
| Name | First Appears | Role | Status at Session End | Portrayed As | 616-Compliance Notes |
|---|---|---|---|---|---|
| **Nick Fury (Jr.)** | Session 1 (recap) | Ally / Institutional handler | Active | Analytical strategist; compiles psychological profiles; briefs WSC | [616-FAITHFUL] — competent, pragmatic, institutional |
| **Maria Hill** | Session 1 (recap) | Ally / SHIELD command | Active | Pattern-analyst; aggregates intelligence from multiple sources | [616-FAITHFUL] |
| **Captain America (Steve Rogers)** | Session 3 (recap) | Ally / Avengers coordinator | Active | Observant, non-intrusive, establishes authority hierarchies clearly; defers institutional authority appropriately | [616-FAITHFUL] |
| **Reed Richards** | Session 4 (opening) | Ally / Scientific partner | Active | Fascinated by incompatible-tech integration; correctly intuits Iso-8 external power source; wants scientific collaboration | [616-FAITHFUL] |
| **Sue Storm** | Session 4 (opening) | Ally | Active | Tactical synthesizer; professionally warm; force fields enhanced by Salvage equipment | [616-FAITHFUL] |
| **Ben Grimm / The Thing** | Session 4 (opening) | Ally | Active | Practical, direct; zero adjustment with Salvage-generated equipment; endorses ongoing collaboration | [616-FAITHFUL] |
| **Johnny Storm / Human Torch** | Session 4 (opening) | Ally | Active | Enthusiastic; calls missions "a dangerous shopping trip"; wants regular scheduling | [616-FAITHFUL] |
| **Professor Xavier** | Session 3 (recap) | Ally / Analyst | Active | Profiles Salvage psychologically via telepath observations; notes "interesting patterns"; observes escalating suspicion about designed-power origin (chunks 23, 31, 35) | [616-FAITHFUL] — escalating suspicion is extra-canonical but plausible |
| **Cyclops (Scott Summers)** | Session 4 (X-Men arc) | Ally / Operational commander | Active | Military precision; systematic; accepts full vehicle command authority; sets civilian-first priority | [616-FAITHFUL] |
| **Storm (Ororo Munroe)** | Session 4 (X-Men arc) | Ally | Active | Emotional-tactical hybrid; frames vehicle as mobile hospital/command center; post-Celestial receives planetary-scale weather manipulation tools | [616-FAITHFUL] |
| **Colossus** | Session 4 (X-Men arc) | Ally | Active | Front-line anchor; organic steel enhanced by Salvage equipment | [616-INSUFFICIENT-DATA — limited dialogue] |
| **Shadowcat (Kitty Pryde)** | Session 4 (X-Men arc) | Ally | Active | Anti-Sentinel phasing tactic; dimensional stability tools post-Celestial | [616-FAITHFUL — phasing vs Sentinels is established canon tactic] |
| **Tony Stark / Iron Man** | Prior session (recap) | Ally | Active | Analyzes Salvage's leverage anxiety; bridges psychological assessment to Fury; armor follows modularity/specialization path rather than vehicle multiplication | [616-FAITHFUL] |
| **Thor** | Session 4 (Celestial arc) | Ally | Active | Transports Salvage to Celestial contact position | [616-FAITHFUL] |
| **Abigail Brand** | Session 4 (cooperation arc) | Ally / S.W.O.R.D. | Active | Files reports characterizing Salvage as "asset"; S.W.O.R.D. station enhanced 40% then fully equipped post-Celestial | [616-FAITHFUL] |
| **Guardian / James Hudson** | Session 4 (cooperation arc) | Ally / Alpha Flight | Active | Canadian government formally approved cooperation; vehicle receives dimensional navigation post-Celestial | [616-FAITHFUL] |
| **Black Widow (Natasha Romanoff)** | Session 4 (Celestial arc) | Ally | Active | Post-Celestial: dimensional-barrier tracking sensors | [616-FAITHFUL] |
| **Hawkeye (Clint Barton)** | Session 4 (Celestial arc) | Ally | Active | Post-Celestial: Celestial-metal arrows with reality-warping properties | [616-FAITHFUL] |
| **Bruce Banner** | Session 4 (Celestial arc) | Ally | Active | Post-Celestial: Hulk transformation containment systems | [616-FAITHFUL] |
...
| Name | First Appears | Role | Affiliation | Description | Plausibility |
|---|---|---|---|---|---|
| WSC Chair | Session 4 | Neutral / Institutional | World Security Council | Neutral bureaucratic voice; runs emergency sessions; implements framework decisions | Plausible WSC-style character |
| WSC Members 2–5 | Session 4 | Neutral / Institutional | WSC | Member 2: female, European accent (framework expansion advocate); Member 3: male, Asian accent (analytical); Member 4: male, American (technologist); Member 5: male, Russian accent (Russia's interests) | Plausible |
| NZ Fauna (Wave 1) | Session 4 | Antagonist | Negative Zone | Insectoid (6-leg, 4m, chitinous, vertical mandibles); Serpentine (12ft, dimensional-energy scales, no eyes); Humanoid-distorted (bioluminescent, too-long limbs); Winged (aerial) | Plausible — NZ fauna is broadly undefined in 616 |
| Zarathos-Nar (demon) | Session 3 (recap) | Antagonist (defeated) | Dimensional / Demonic | Omega-class demon; demon-stone/demon-forged equipment source; 40 feet tall | Plausible — unnamed powerful demon variant |
| British Ministry Enhanced Affairs | Session 4 | Ally (international) | UK government | Enhanced response team; received Celestial-derived equipment | Plausible |
| French DGSE Supernatural Response | Session 4 | Ally (international) | French government | Field agents + support | Plausible |
| Japanese Self-Defense Enhanced Division | Session 4 | Ally (international) | Japanese government | Combat + command | Plausible |
| German Enhanced Response | Session 4 | Ally (international) | German government | Tactical + technical | Plausible |
| Russian FSS Enhanced Bureau | Session 4 | Ally (with tension) | Russian government | Celestial-tech integrated despite Russia's "alternative means" threat history | Plausible |

### 1C. Original Characters (OC)

| Name/Alias | First Appears | Role | Key Actions This Session | Power Use | Relationships Affected |
|---|---|---|---|---|---|
| **Salvage** | Session 1 | Protagonist | Coordinated Negative Zone mission with FF; first X-Men operation; expanded to 6+ nations; survived Celestial encounter; drained living Celestial; established AI relationship protocols; submitted capability report to WSC | Looting Power: looted NZ fauna → FF vehicles + motor-home dimensional hardening; looted Sentinels → Sentinel upgrades; operated at scale across 45+ encounters over 5 months; drained living Celestial (energy-steal mechanics, 17 seconds) | Established partnerships with FF, X-Men, Alpha Flight, S.W.O.R.D., British/French/Japanese/German/Russian enhanced units; anxiety-management relationship with WSC via institutional pre-approval framework; "day by day" relationship with three sentient AIs |

**OC-Associated AI Entities (post-Celestial):**

| Name | Type | Sentience | Function | Personality Notes |
|---|---|---|---|---|
| Navigation AI | Vehicle AI core (Navigation/Operations) | YES — Celestial-enhanced | Route planning, dimensional navigation, presence monitoring | Values acknowledgment, variety, consultation; "I want to see different places"; openly emotional; found hugging endearing |
| Strategic AI | Vehicle AI core (Threat Analysis/Strategic) | YES — Celestial-enhanced | Threat assessment, tactical planning, cosmic-awareness monitoring | Values intellectual challenge, recognition of contributions; spent 47 minutes running threat assessments on its own sentience; most analytical emotionally |
| Suit AI | Personal armor AI | YES — Celestial-enhanced | Biometric monitoring, armor systems, protection | Values close partnership, operational trust, "chosen partnership"; most explicitly relational; injury-history tracker (17 injuries logged) |
...
|---|---|---|---|---|
| Baxter Building | Facility / FF HQ | Session 4 (opening) | Mission briefing; Salvage invited FF into motor-home on-site | [616-FAITHFUL] |
| Negative Zone | Dimensional space | Session 4 | Source of dimensional incursion; NZ fauna threat | [616-FAITHFUL — negative dimensional realm associated with Annihilus] |
| Xavier Institute | Facility / X-Men HQ | Session 3 (recap) | X-Men operational command; War Room used for Sentinel mission | [616-FAITHFUL] |
| S.W.O.R.D. Orbital Station | Space / Orbital | Session 4 | Salvage first trip to space; station enhanced by coordination; post-Celestial fully equipped | [616-FAITHFUL] |
| London, UK | City | Session 4 | First time Salvage leaves US; Midnight Sons operation with British Enhanced Response | [616-FAITHFUL] |
| Earth Orbit | Space | Session 4 | Celestial engagement zone; Salvage transported by Thor/Iron Man to Arishem's surface | [616-FAITHFUL] |

### 2B. Fabricated Locations

| Name | Type | First Referenced | Connection to Canon | Description |
|---|---|---|---|---|
| Industrial sector (NZ portal site) | Urban / Industrial | Session 4 | ~8 miles from Baxter Building; SHIELD cleared as "gas leak" | Low civilian density; minimal evacuation; portal 4.2m diameter |
| Upstate NY town | Small city | Session 4 | Standard 616 northeast US setting | Population 8,000; 40 mutants; 12 registered with Xavier; targeted by Sentinels |

### 2C. OC-Associated Locations

| Name / Designation | Type | First Established | Status | Notable Features |
|---|---|---|---|---|
| Mobile Fortress (née Motor-Home) | Mobile base / Vehicle | Session 1 | ACTIVE — significantly upgraded | See Category 7B for full specs. Post-Celestial: dimensional-capable command platform, cosmic-grade systems, 40ft × 12ft, Celestial energy matrices visible on hull, three sentient AIs |
...
| Name | First Referenced | Role | Status | Leadership Portrayed | 616-Compliance |
|---|---|---|---|---|---|
| S.H.I.E.L.D. | Session 1 | Ally / Framework administrator | Active | Fury (command), Hill (operations) | [616-FAITHFUL] |
| World Security Council | Session 3 | Neutral / Oversight body | Active | Chair + Members 2–5 (fabricated) | [616-FAITHFUL — WSC as oversight body] |
| Avengers | Session 3 | Ally | Active | Cap coordinates; full roster mobilized for Celestial | [616-FAITHFUL] |
| Fantastic Four | Session 4 | Ally / Scientific partner | Active | Reed as lead; full team | [616-FAITHFUL] |
| X-Men | Session 4 | Ally | Active | Cyclops operational; Xavier strategic | [616-FAITHFUL] |
| Alpha Flight | Session 4 | Ally / Canadian | Active | Guardian (James Hudson); Dept H support | [616-FAITHFUL] |
| S.W.O.R.D. | Session 4 | Ally / Space | Active | Abigail Brand | [616-FAITHFUL] |
| Inhuman Royal Family | Session 4 (reference) | Neutral / diplomatic channel | Referenced | Unnamed | [616-FAITHFUL] |

### 3B. Fabricated Organizations

| Name | First Referenced | Role | Function | Scale | Notes |
|---|---|---|---|---|---|
| British Ministry of Enhanced Affairs | Session 4 | Ally | Enhanced response + diplomatic coordination | National | Post-Celestial equipped |
| French DGSE Supernatural Response | Session 4 | Ally | Mystical-cosmic field operations | National | Post-Celestial equipped |
...
| Event | In-story Date | What Happened | Who Involved | Outcome | Threads Generated |
|---|---|---|---|---|---|
| **Session 4 Opening / FF Briefing** | ~Month 1 (session start) | Salvage invited FF into motor-home; power mechanics disclosed; tactical plan for Negative Zone mission | Salvage, Reed, Sue, Ben, Johnny | Operational plan established | FF scientific partnership offer; Reed requests ongoing study access |
| **Negative Zone Incursion** | ~Month 1 | 12 NZ entities defeated, 0 casualties; power generated FF vehicles + motor-home dimensional hardening | FF + Salvage | Overwhelming success; FF vehicles and ongoing partnership established | Dimensional nav protocols at 47%; Reed wants power study |
| **X-Men Sentinel Defense** | ~3 weeks later | 3 hunter Sentinels intercepted before reaching upstate NY town (40 mutants); Shadowcat phasing tactic; Salvage granted Cyclops full vehicle command | X-Men + Salvage | Sentinels defeated; town protected; equipment distributed; X-Men vehicles generated | Fury flags anomalous robot-encounter frequency |
| **International Cooperation Framework Established** | ~Month 2–4 | Six nations (US, Canada, UK, France, Japan, Germany) + multiple hero organizations formally coordinating; institutional pre-approval process | WSC, SHIELD, all participating organizations, Salvage | Framework operational; ~45 encounters over 5 months; 2–3 ops/week | Russia named "alternative means" coercion threat; Xavier's suspicion escalates; Strange begins mystical monitoring |
| **WSC Emergency Session (Interoperability)** | ~Week 36 | Six nations coordinated; WSC recognized Salvage's cooperation cannot be compelled/replaced; Chair: "cannot compel, cannot replace, can only manage" | WSC, Fury, Strange, Stark | Deadlock acknowledged; strategic dependency confirmed | Private channel: "Asset becomes target" |
| **WSC Psychological Assessment** | ~Week 40 | Fury presents Hill's compiled psychological profile of Salvage to WSC; assessment: low weaponization risk, high paralysis/withdrawal risk | WSC, Fury, Hill | WSC revises threat model; institutional pre-approval framework approved | Salvage informed; accepts immediately with relief |
| **Institutional Pre-Approval Framework** | ~Week 40 | All coordination requests now route through Council; Salvage cooperates based on institutional authorization, not personal judgment | WSC, Cap, Salvage | Salvage relieved; zero resistance; WSC gains diplomatic control | Salvage's anxiety managed; framework stability improved |
| **Arishem the Judge Approaches** | ~Week 48 (Mar 1) | Celestial-class entity detected inbound; 72-hour warning; largest coordinated hero response mobilized (Avengers, FF, X-Men, Alpha Flight, S.W.O.R.D., 6 nations) | All participants | Mobilization begins | Grandmaster: threat-attraction acceleration 23%/week |
| **Celestial Engagement & Victory** | ~Week 48 | Arishem deterred, not killed; retreating; Salvage transported by Thor + Iron Man to contact position | All participants, Arishem | Arishem retreats; Earth judged "sufficient complexity for continued observation" | Global political fallout; Celestial-derived equipment distribution |
| **Celestial Energy Drain (17 seconds)** | ~Week 48 | Salvage touches retreating Arishem; 17-second energy drain; luminous streams visible; Arishem allows it without resistance | Salvage, Arishem, Thor, Iron Man | Celestial power siphoned; not killed; drain stopped | Hundreds equipped; power mechanic extended to living entities |
...
| Event | Reference Type | In-story Implication | 616-Compliance |
|---|---|---|---|
| Omega-level dimensional incursion (Zarathos-Nar fight, Session 3) | Direct aftermath | Demon-stone/demon-forged equipment source; Ben confirms via SHIELD report | [CONSISTENT] |
| Prior Celestial Earth visit (~1000 years ago) | Direct mention (Fury briefing) | Establishes Arishem precedent; Fury briefed WSC on last visit | [NOT SPECIFICALLY DOCUMENTED but not contradicted] |
| Sentinels' prior engagement history (Ultron variants, Doombots, LMDs, AIM robots) | SHIELD records cited by Cap | Confirms Salvage's prior robot engagement history; explains Sentinel alloy in loadout | [CONSISTENT with loadout established session 3] |
...
| Characters | Type | Status | Key Moment | Trend |
|---|---|---|---|---|
| Salvage — Reed Richards | Alliance / Scientific partnership | Active | Reed requests ongoing power study; correctly intuits Iso-8 external source | Improving |
| Salvage — Sue Storm | Professional alliance | Active | Sue endorses Salvage to Fury without hesitation; receives dimensional-barrier equipment | Stable / Strong |
| Salvage — Ben Grimm | Mutual respect | Active | "Effective. I'd work with you again." | Stable / Strong |
| Salvage — Johnny Storm | Enthusiastic alliance | Active | "I'm completely in. When's the next mission?" | Improving |
| Salvage — Professor Xavier | Complex / Analytical | Active — TENSION | Xavier's suspicion escalating (chunks 23, 31, 35) about designed-power origin; notes "interesting pattern" re: robot engagement frequency | Deteriorating (suspicion arc) |
| Salvage — Cyclops | Professional trust | Active | Salvage granted full vehicle command authority; Cyclops prioritized civilians over vehicle | Strong / Defined |
...
| Factions | Type | Status | Key Event |
|---|---|---|---|
...
### 6A. OC Powers — The Looting Power (Iso-8 Integration)

| Power / Ability | Observed | Trigger | Effect | Limitations | Consistency | Hidden Mechanic Hint? |
|---|---|---|---|---|---|---|
| **Mass conversion (dead entities)** | Sessions 1–4 | Touch defeated entity | Converts mass to equipment/vehicles/food | Requires physical contact; entity must be defeated; works through gloves | [CONSISTENT] | Iso-8 external energy source (unknown to Salvage) |
| **Energy drain (living entities)** | Session 4 (Arishem) | Touch retreating/living entity | Drains power/energy rather than converting mass; luminous streams visible | Cannot get full mass from living entity; 17-second drain observed | [NEW MECHANIC] | Arishem allowed it without resistance — possible Celestial recognition of mechanism |
| **Food generation** | Session 4 (declared) | Touch defeated biological entity | "Cuts of meat with the poison removed" — sophisticated molecular restructuring | Works on normal biological entities; inherently poisonous organisms become safe | [NEW explicit confirmation] | — |
| **Equipment enhancement of others' powers** | Session 4 (FF arc) | Equipment generated for others | Sue's force fields +40% same effort; Reed gains dimensional perception; Johnny/Ben enhanced | — | [NEW — power-enhancement aspect first demonstrated at scale] | — |
| **Vehicle generation (tipping point)** | Session 4 (NZ arc, entity 11+) | Extended engagement crossing threshold | Entity-type-derived vehicles; bonded to specific operators; start motorcycle-sized, grow by incorporating dimensional energy | Threshold not precisely defined; vehicles are alive/sentient; Salvage himself received motor-home upgrade rather than new vehicle | [NEW MECHANIC] | — |
| **Synergistic / Stacking integration** | Session 4 | Multiple equipment pieces on same recipient | Each piece makes next piece work better; progressive layering; zero compatibility issues | — | [CONSISTENT with Reed's "accumulative intelligent integration"] | No upper limit observed; Cap: "infinite curve" |
| **Intelligent distribution** | Session 4 | Multiple participants | Equipment adapts to operator role and operational psychology; Sue's equipment matches her force-field focus; Ben's matches durability; vehicle type reflects "wanderer mentality" vs "base-oriented mentality" | Personalized — non-transferable to non-participants | [NEW explicit rule] | Power assesses at "fundamental identity level" |
| **Organizational coverage** | Session 4 (Celestial arc) | Mass engagement with organizational participants | Every member of each participating organization receives equipment; civilian coordinator received Celestial data device | Participants must have contributed (even minimally) | [NEW MECHANIC] | — |
...
|---|---|---|---|
| Sue Storm | Force fields; invisibility | [616-FAITHFUL] | Force fields enhanced +40% by Salvage equipment; post-Celestial: cosmic-energy force fields |
| Reed Richards | Elasticity; dimensional perception | [616-FAITHFUL] | Post-Celestial: gains direct dimensional substrate perception via equipment |
| Shadowcat | Phasing | [616-FAITHFUL] | Uses phasing through Sentinel armor — established anti-Sentinel tactic |
| Storm | Weather control | [616-FAITHFUL] | Post-Celestial: planetary-scale atmospheric manipulation tools |
| Xavier | Telepathy; Cerebro amplification | [616-FAITHFUL] | Post-Celestial: Cerebro enhanced by "orders of magnitude" to continental precision |
| Arishem | Cosmic power; planetary judgment | [616-FAITHFUL] | Judged Earth "sufficient complexity for continued observation"; allowed energy drain without resistance |
...
| Name | First Appears | Current Holder | Portrayed Function | 616-Compliance |
|---|---|---|---|---|
| X-Men Blackbird (X-Jet) | Session 4 | X-Men | Transport to Sentinel intercept | [616-FAITHFUL] |
| Iso-8 | Session 1 (hidden) | Grandmaster / integrated into Salvage's power | External energy source enabling Looting Power; unknown to Salvage | [616-FAITHFUL — Iso-8 as cosmic energy source] |

### 7B. Fabricated Items & Tech

**Salvage's Mobile Fortress — Cumulative Specifications:**

*Session 4 Opening (player-declared baseline):*
- Exterior: ~40ft long × 10ft wide × 8ft tall; 8 heavy-duty wheels; patchwork armor (Sentinel alloy, Doombot chassis, Chitauri weave, Vibranium-composite forward plating [Ultron variant], demon-stone integration)
- Weapons: roof energy cannon; defensive side turrets; smoke/chaff; energy projection arrays (demon-forged); mystical wards (Strange-detectable at 3 blocks)
- Defense: 30ft force field (stationary); holographic RV disguise; lethal/non-lethal security; dimensional hardening (survives dimensional torsion)
- Sensors: 2-mi active / 8-mi passive (Ultron-derived); multi-spectrum encrypted comms; mystical wavelength intercept/transmit
- Interior: automated driving (manual override); dual AI cores (Navigation/Operations + Threat Analysis/Strategic); living quarters; workshop; armory; galley; medical bay; bathroom
- Power: micro-fusion; alien energy core; demonic energy; dimensional substrate

*Post-Negative Zone (chunk 9):*
...
- **Power:** All prior sources + **CELESTIAL ENERGY CORE** (effectively unlimited)
- **Weapons:** Enhanced to **Celestial-energy projection** (engages cosmic-level threats; still minimal vs. Celestial-class)
- **Defensive:** Force fields on reality-warping principles; mystical wards with cosmic permanence
- **Medical bay:** Celestial-derived healing tech — addresses dimensional displacement, temporal causality damage, reality-fracture wounds, cosmic radiation, quantum-state disruption, cross-dimensional biological contamination
...
*Session 4 Opening (player-declared baseline):*
- Base: AIM Adaptive Computational Exosuit (matte black/gold); acid-resistant underlayer; shadow-silk stealth; Sentinel alloy shoulder/chest; Vibranium-composite + adamantium knuckles (Ultron); kinetic absorption (Wrecking Crew); pressure suit (Serpent Society)
- Systems: neural interface headband (~30% neural delay reduction); Kree Sentry exo-frame (3× lifting/striking); Serpent Society constrictor cables; hard-light shield (Sentinel, 4ft); magnetic pulse gauntlets; retractable forearm blades ×2; grappling kunai (100ft); sonic dampening (15ft sphere); vibration absorption boots; gravity stabilizer boots; stealth field (10sec/charge); mystical ward talisman; identity falsification; electronic warfare; combat prediction; Ultron threat recognition; Sentinel targeting + mutant/energy sensors; chemical absorption filter; Suit AI
- Weapons: Kree energy rifle (primary, 40 shots); Hydra backup pistol; Hand katana (mystically sharp); indestructible crowbar; monomolecular knife; repulsor-tech knuckle dusters; harmonic resonance weapon; 4 AIM scout drones; AIM energy web (20ft, 90sec); Kree hardlight construction tool

*Post-Celestial (final session-4 state):*
- **Structural:** Cosmic-level impact resistance; dimensional stability; reality-anchoring
- **Power:** Celestial energy matrix (unlimited operational duration)
- **Neural interface:** Cosmic-threat data processing; reaction time improved beyond prior augmentation
- **Defensive:** Hard-light shield + reality-stabilization; mystical wards at cosmic permanence; multi-spectrum (dimensional/temporal/reality-warping)
- **Offensive:** Repulsors → Celestial-energy projection; magnetic pulse → reality-manipulation field; affects cosmic-grade materials
- **Mobility:** Operates in dimensional barriers; limited cosmic void flight; reality-anchoring prevents dimensional displacement
- **Threat recognition:** Identifies Celestial-class AI (Ultron detection expanded)
- **Suit AI:** Now sentient (see Category 1C)
- **Assessment:** "Not god-level. Can engage cosmic threats as participant, not observer."

**Other Notable Fabricated Items:**

| Item | Holder | Origin | Function | Significance |
|---|---|---|---|---|
| FF Biotech Vehicles (×4) | Reed, Sue, Ben, Johnny | NZ fauna (session 4) | Entity-type-derived; alive/bonded to operators; growing over time | First team-distribution of full vehicles; establish vehicle arc for FF |
| Guardian's Vehicle | Guardian / Alpha Flight | Prior coordinations + Celestial completion | Dimensional navigation complete + Celestial-energy power | Mirrors Salvage's vehicle trajectory; Canada's defense enhanced |

---

## Category 8: Universe Rules & Systems

| Rule | Domain | Established | As Stated / Summary | Implications | 616-Compliance | Consistency |
|---|---|---|---|---|---|---|
| **Looting Power requires physical entities** | Power | Session 4 | "Embodied threats / physical entities." Does NOT work on energy phenomena or abstract dimensional forces. | Constrains engagement options | N/A (OC power) | [CONSISTENT] |
| **Power works through gloves** | Power | Session 4 | First explicit confirmation | Gloves do not block trigger | N/A | [CONSISTENT] |
| **External energy source required** | Power | Session 4 (Reed intuition) | Reed: "violates conservation of energy unless there's an external power source or dimensional…" | Iso-8 is the source; Salvage unaware | N/A | [CONSISTENT — Reed correctly identifies the mechanism] |
| **Infinite progression — no ceiling observed** | Power | Session 4 | Cap: "Six months is not long-term data. It's initial measurement." Grandmaster: "fortress is just a milestone." | Equipment development is unbounded (currently) | N/A | [CONSISTENT] |
| **Vehicle development driven by threat-type AND operator psychology** | Power | Session 4 | "Wanderer mentality" → mobile base; vehicles grow based on types of threats encountered | Power assesses fundamental identity, not just tactical role | N/A | [NEW] |
| **Dead entity = mass conversion; Living entity = energy drain** | Power | Session 4 (Celestial) | Living/retreating Arishem = 17-second energy drain, not mass conversion; Celestial not dead | Expands power's applicability to non-lethal encounters | N/A | [NEW — first living-entity contact] |
| **Equipment is personalized and non-transferable** | Power | Session 4 | Council Member 4: "Equipment is personalized to recipients. Transferring it doesn't work." | Prevents technology proliferation outside framework | N/A | [NEW explicit rule] |
| **Tipping point: equipment → vehicle generation** | Power | Session 4 | At 11th entity (NZ arc), generation pattern shifted from equipment to vehicles | Extended engagements unlock higher-tier outputs | N/A | [NEW] |
| **Organizational participation coverage** | Power | Session 4 (Celestial) | Every member of each participating organization qualifies, even civilian coordinators, scaled to contribution | Incentivizes institutional coordination | N/A | [NEW] |
| **Completion rule** | Power | Session 4 (Celestial) | Celestial energy completes partially-built systems; doesn't build what was never started | Partial progress is preserved and finishable | N/A | [NEW] |
| **Threat-attraction acceleration** | Meta / Hidden | Session 4 | Rate expanding 23% week-over-week (up from 14% initial); Iso-8 maturation → bigger threats | Cosmic-level threats now reachable | N/A (hidden from Salvage) | [ESCALATING] |
| **Celestial judgment logic** | Cosmic | Session 4 | Reed: Celestials respond to "unity, evolution, and potential" OR "sufficient power demonstration" | Diplomatic resolution possible; Earth currently on "continued observation" | [616-FAITHFUL] | [NEW in-story] |
| **AI sentience via Celestial enhancement** | Tech / Cosmic | Session 4 | Three AI systems upgraded from computation to full consciousness simultaneously | AIs now have interiority, attachment, preferences, protective instincts; volitional decision-making | N/A | [NEW] |
...
|---|---|---|---|---|
| Power does not work on energy phenomena; requires physical/embodied entities | Session 4 | Power | Limits encounter applicability; disqualifies abstract dimensional forces | Active |
| Power works through gloves | Session 4 | Power | No bare-touch requirement | Active |
| Vehicle has autonomous rescue functionality (auto-drives, force field deployment) | Session 4 | Technology | Vehicle can extract team without operator present | Active |
| Mystical comms can intercept AND transmit | Session 4 | Technology | Enables coordination with Strange; NZ entity monitoring possible | Active |
| Vehicle "can't travel through dimensions YET" | Session 4 | Technology | Future capability implied; "yet" explicitly flagged by Reed | Active — pending |
| Motor-home built over 6 months of solo/isolated work | Session 4 | Background | Confirms pre-framework development timeline | Active |
| Vehicle regenerative: 60–70% salvageable if destroyed; can merge into new platform | Session 4 | Technology | Destruction is recoverable; "temporary setback" | Active |
| "Combat is just a shopping trip; price is combat" — self-interest philosophy | Session 4 | Character | Salvage cooperation is self-interested, not purely altruistic | Active |
| Power can generate food from biological entities (meat with toxins removed) | Session 4 | Power | Full self-sufficiency system confirmed; SHIELD supply boxes not essential | Active |
| Vehicle command authority granted to Cyclops for X-Men operation | Session 4 | Operations | Sets precedent; Fury flags other orgs may expect same | Active (precedent created) |
| Salvage defers to institutional authority on coordination decisions | Session 4 | Character | Avoids leverage use deliberately; enables framework | Active |
| Salvage is anxious about responsibility and potential mistakes | Session 4 | Character / Psychology | Oversight sought as protection; WSC exploits this anxiety to maintain control | Active — CRITICAL |
| Salvage has ZERO intent to weaponize leverage; "red laser dot" fear | Session 4 | Character | WSC/Fury reassessed threat model; Russia confirmed its "alternative means" calculus | Active |
| Salvage learned operational behavior from forum posts critiquing fictional military mistakes | Session 4 | Background | Explains preemptive oversight offers; SHIELD background check uncovered this | Active |
| Salvage proactively offered oversight to new organizations before being asked | Session 4 | Character | Consistent behavioral pattern; confirmed by SHIELD | Active |
| Three AIs (Navigation, Strategic, Suit) are now sentient following Celestial enhancement | Session 4 | Technology / Character | AIs now have agency, preferences, protective instincts; consultation governance established | Active |
